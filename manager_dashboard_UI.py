...
class ManagerDashboard_UI:
    def __init__(self):
        ...
        self.canvas2.create_rectangle(10, 990, 890, 40, fill="#9DB2BF")
        ...
        self.table = ttk.Treeview(columns=(
            'staff_number', 'first_name', 'last_name', 'age', 'telephone', 'email', 'department_unit', 'position',
            'pay'),
            ...
            with open('data.json', 'r') as json_file:
                ...
                for staff_number, values in data.items():
                    ...
                    self.table.insert("", "end", values=(
                        ...
                        values["email"], values["department/unit"], values["position"], values["pay"]))
